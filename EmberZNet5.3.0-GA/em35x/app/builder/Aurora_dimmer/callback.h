...
/** @brief Basic Cluster Send Transparent Command
 *
 * 
 *
 * @param payload   Ver.: always
 */
boolean emberAfBasicClusterSendTransparentCommandCallback(int8u* payload);
/** @brief Basic Cluster Send Transparent Command Response
 *
 * 
 *
 * @param payload   Ver.: always
 */
boolean emberAfBasicClusterSendTransparentCommandResponseCallback(int8u* payload);
...
/** @brief Simple Metering Cluster Get Notification Flag
 *
 * 
 *
 * @param notificationScheme   Ver.: always
...
boolean emberAfPrepaymentClusterEmergencyCreditSetupCallback(int32u issuerEventId,
                                                             ...
                                                             int32u emergencyCreditLimit,
                                                             int32u emergencyCreditThreshold);
/** @brief Prepayment Cluster Get Command
 *
 * 
 *
...
/** @brief Prepayment Cluster Get Debt Repaymenty Log
 *
 * 
 *
...
/** @brief Prepayment Cluster Get Prepay Snapshot Response
 *
 * 
 *
 * @param issuerEventId   Ver.: always
...
/** @brief TOU Calendar Cluster Cancel Calendar
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfTouCalendarClusterCancelCalendarCallback(int32u providerId,
                                                        int32u issuerEventId,
                                                        int8u calendarType);
/** @brief TOU Calendar Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfTouCalendarClusterClientAttributeChangedCallback(int8u endpoint,
                                                             EmberAfAttributeId attributeId);
/** @brief TOU Calendar Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
...
void emberAfTouCalendarClusterClientDefaultResponseCallback(int8u endpoint,
                                                            int8u commandId,
                                                            EmberAfStatus status);
/** @brief TOU Calendar Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
/** @brief TOU Calendar Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfTouCalendarClusterClientManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 int16u manufacturerCode);
/** @brief TOU Calendar Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
...
void emberAfTouCalendarClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                        ...
                                                        int8u *message,
                                                        EmberStatus status);
/** @brief TOU Calendar Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
EmberAfStatus emberAfTouCalendarClusterClientPreAttributeChangedCallback(int8u endpoint,
                                                                         ...
                                                                         int8u size,
                                                                         int8u *value);
/** @brief TOU Calendar Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
...
/** @brief TOU Calendar Cluster Get Calendar
 *
 * 
 *
 * @param earliestStartTime   Ver.: always
...
boolean emberAfTouCalendarClusterGetCalendarCallback(int32u earliestStartTime,
                                                     ...
                                                     int8u calendarType,
                                                     int32u providerId);
/** @brief TOU Calendar Cluster Get Calendar Cancellation
 *
 * 
 *
 */
boolean emberAfTouCalendarClusterGetCalendarCancellationCallback(void);
/** @brief TOU Calendar Cluster Get Day Profiles
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfTouCalendarClusterGetDayProfilesCallback(int32u providerId,
                                                        ...
                                                        int8u startDayId,
                                                        int8u numberOfDays);
/** @brief TOU Calendar Cluster Get Seasons
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfTouCalendarClusterGetSeasonsCallback(int32u providerId,
                                                    int32u issuerCalendarId);
/** @brief TOU Calendar Cluster Get Special Days
 *
 * 
 *
 * @param startTime   Ver.: always
...
boolean emberAfTouCalendarClusterGetSpecialDaysCallback(int32u startTime,
                                                        ...
                                                        int32u providerId,
                                                        int32u issuerCalendarId);
/** @brief TOU Calendar Cluster Get Week Profiles
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfTouCalendarClusterGetWeekProfilesCallback(int32u providerId,
                                                         ...
                                                         int8u startWeekId,
                                                         int8u numberOfWeeks);
/** @brief TOU Calendar Cluster Publish Calendar
 *
 * 
 *
 * @param providerId   Ver.: always
...
/** @brief TOU Calendar Cluster Publish Day Profile
 *
 * 
 *
 * @param providerId   Ver.: always
...
/** @brief TOU Calendar Cluster Publish Seasons
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfTouCalendarClusterPublishSeasonsCallback(int32u providerId,
                                                        ...
                                                        int8u totalNumberOfCommands,
                                                        int8u* seasonEntries);
/** @brief TOU Calendar Cluster Publish Special Days
 *
 * 
 *
 * @param providerId   Ver.: always
...
/** @brief TOU Calendar Cluster Publish Week Profile
 *
 * 
 *
 * @param providerId   Ver.: always
...
/** @brief TOU Calendar Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfTouCalendarClusterServerAttributeChangedCallback(int8u endpoint,
                                                             EmberAfAttributeId attributeId);
/** @brief TOU Calendar Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
...
void emberAfTouCalendarClusterServerDefaultResponseCallback(int8u endpoint,
                                                            int8u commandId,
                                                            EmberAfStatus status);
/** @brief TOU Calendar Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
/** @brief TOU Calendar Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfTouCalendarClusterServerManufacturerSpecificAttributeChangedCallback(int8u endpoint,
                                                                                 EmberAfAttributeId attributeId,
                                                                                 int16u manufacturerCode);
/** @brief TOU Calendar Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
...
void emberAfTouCalendarClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                        ...
                                                        int8u *message,
                                                        EmberStatus status);
/** @brief TOU Calendar Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
EmberAfStatus emberAfTouCalendarClusterServerPreAttributeChangedCallback(int8u endpoint,
                                                                         ...
                                                                         int8u size,
                                                                         int8u *value);
/** @brief TOU Calendar Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
...
/** @brief Device Management Cluster Change Supply
 *
 * 
 *
 * @param supplierId   Ver.: always
...
/** @brief Device Management Cluster Get Change Supply
 *
 * 
 *
 */
...
/** @brief Device Management Cluster Get Uncontrolled Flow Threshold
 *
 * 
 *
 */
boolean emberAfDeviceManagementClusterGetUncontrolledFlowThresholdCallback(void);
/** @brief Device Management Cluster Local Change Supply
 *
 * 
 *
 * @param proposedSupplyStatus   Ver.: always
...
/** @brief Device Management Cluster Publish Uncontrolled Flow Threshold
 *
 * 
 *
 * @param providerId   Ver.: always
...
boolean emberAfDeviceManagementClusterSetEventConfigurationCallback(int32u issuerEventId,
                                                                    ...
                                                                    int8u* eventConfigurationPayload);
/** @brief Device Management Cluster Set Supply Status
 *
 * 
 *
 * @param issuerEventId   Ver.: always
...
/** @brief Device Management Cluster Supply Status Response
 *
 * 
 *
 * @param providerId   Ver.: always
...
/** @brief Events Cluster Clear Event Log
 *
 * 
 *
...
/** @name Aurora Tunneling server cluster Plugin Callbacks */
// @{
...
/** @} END Aurora Tunneling server cluster Plugin Callbacks */
