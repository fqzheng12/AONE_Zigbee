 ...
 *   - <i>Creates the payload for an over the air message that turns identifying on for a given endpoint and a given amount of time</i>
 ...
 *   - <i>Creates a message payload for a command that turns identifying off on a given endpoint.</i>
